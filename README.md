...
Botbro is a fully local, privacy-first AI desktop orchestration system for Windows built with Python. It combines:
...
into a unified assistant capable of interacting with the user's desktop completely offline. Unlike traditional cloud-based assistants, Botbro performs inference, automation, rendering, and orchestration directly on-device using local models powered by Ollama.

## Table of Contents

- [Overview](#overview)
- [Core Capabilities](#core-capabilities)
  - [🧠 Local AI Intent Engine](#-local-ai-intent-engine)
  - [🔒 Privacy & Security Layer](#-privacy--security-layer)
  - [🖥 Desktop Orchestration Layer](#-desktop-orchestration-layer)
  - [🎨 Autonomous Rendering & Drawing Engine](#-autonomous-rendering--drawing-engine)
  - [🎙 Voice Interaction System](#-voice-interaction-system)
...
- [Research & Engineering Areas](#research--engineering-areas)
- [License](#license)
- [Author](#author)

## Overview

Botbro acts as an intelligent automation layer over the Windows desktop. It can:
...
Sensitive information is detected locally and masked before being sent to the LLM. The system:
...
One of Botbro's most advanced subsystems is the autonomous rendering engine capable of drawing images directly in Microsoft Paint. The rendering system evolved from simple mouse automation into a full contour-processing and rendering orchestration pipeline.
...
**/core**  
Central orchestration engine. Contains:
- CommandExecutor
- MemoryManager
- PIIEngine
- Session handling
...
**/services**  
AI communication layer. Contains:
- AIService
- OllamaService
- Prompt templates
- JSON intent parsing
...
**/automation**  
Execution and rendering modules. Contains:
- AppController
- DrawEngine
- ImageTracer
- MouseAutomator
...
**/gui**  
PyQt5 graphical interface. Features:
- Async chat interface
- Live command interaction
- Non-blocking task execution

**/voice**  
Voice input/output subsystem. Features:
- Microphone input
- Speech recognition
...
1. **Clone Repository**
   ```bash
   git clone https://github.com/yourusername/botbro.git
   cd botbro
   ```
...
3. **Install Dependencies**
   ...
   **Major Dependencies**
   ...
   |-------------|-----------|
   | GUI         | PyQt5 |
   | Vision      | OpenCV, Potrace |
   | Voice       | SpeechRecognition, PyAudio, pyttsx3 |
   | Automation  | pyautogui, pywin32, pygetwindow |
   | AI          | Ollama |
   | System      | psutil, winreg |
   | Utility     | pyperclip, numpy, scipy |
...
|---------------------|-----------------|
| AI Inference        | Fully local |
| Rendering           | Adaptive vector plotting |
| Voice Processing    | Offline |
| Drawing Complexity  | Handles dense contour graphs |
| Storage             | SQLite session memory |
| Networking          | Optional only for image retrieval |
...
We welcome contributions to Botbro! If you'd like to contribute, please:
...
**Babul Kumar**  
[GitHub](https://github.com/Babul-Kumar) | [LinkedIn](https://linkedin.com/in/babul-kumar) | [Email](mailto:babul@example.com)

---

*Botbro is an open-source project. Contributions and feedback are welcome!*